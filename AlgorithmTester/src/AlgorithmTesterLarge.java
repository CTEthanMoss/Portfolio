...
public class AlgorithmTesterLarge {
...
public static void main(String[] args) throws FileNotFoundException {
   ...
   //printing lists from text file before sorting
    System.out.println("Ordered large List");
    reader.readFile(reader.orderedFileLarge, reader.orderedListLarge);
    System.out.println("Reverse large List");
    reader.readFile(reader.reverseFileLarge, reader.reverseListLarge);
    System.out.println("Random large List");
    reader.readFile(reader.randomFileLarge, reader.randomListLarge);
...
//Repeat after each list is sorted to reinstate unsorted list
    comparisons = 0;
    exchanges = 0;
    ArrayList<Integer> orderedBubble = new ArrayList<>(reader.orderedListLarge);
    ...
    comparisons = 0;
    exchanges = 0;
    ArrayList<Integer> reverseBubble = new ArrayList<>(reader.reverseListLarge);
    ...
    comparisons = 0;
    exchanges = 0;
    ArrayList<Integer> randomBubble = new ArrayList<>(reader.randomListLarge);
    ...
    comparisons = 0;
    exchanges = 0;
    ArrayList<Integer> orderedSelection = new ArrayList<>(reader.orderedListLarge);
    ...
    comparisons = 0;
    exchanges = 0;
    ArrayList<Integer> reverseSelection = new ArrayList<>(reader.reverseListLarge);
    ...
    comparisons = 0;
    exchanges = 0;
    ArrayList<Integer> randomSelection = new ArrayList<>(reader.randomListLarge);
    ...
    comparisons = 0;
    exchanges = 0;
    ArrayList<Integer> orderedInsertion = new ArrayList<>(reader.orderedListLarge);
    System.out.println("Ordered List:");
    ...
    comparisons = 0;
    exchanges = 0;
    ArrayList<Integer> reverseInsertion = new ArrayList<>(reader.reverseListLarge);
    System.out.println("Reverse large list:");
    ...
    comparisons = 0;
    exchanges = 0;
    ArrayList<Integer> randomInsertion = new ArrayList<>(reader.randomListLarge);
    System.out.println("Random List:");
